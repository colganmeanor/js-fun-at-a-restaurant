...
var vegetables = ['cucumber', 'brussel sprouts', 'brocolli', 'cauliflower', 'eggplant']
...
var fruits = ['apple', 'grape', 'banana', 'blueberry', 'strawberry', 'raspberry', 'kiwi']
...
// some other keys that would make sense for this object would be numberOfStaff (assigned to a number), sellsAlcohol (assigned to a boolean value)
// and address (assigned to a string value)
